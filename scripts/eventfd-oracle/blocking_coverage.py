"""Coverage target for controlled eventfd wait and wakeup scenarios."""
...
TARGET_SET_ID = "eventfd-blocking-v1"
TARGET_SOURCE_PATHS = tuple(
    sorted(
        (
            "components/axpoll/src/lib.rs",
            "os/StarryOS/kernel/src/file/event.rs",
            "os/StarryOS/kernel/src/syscall/fs/event.rs",
            "os/StarryOS/kernel/src/syscall/fs/fd_ops.rs",
            "os/StarryOS/kernel/src/syscall/fs/io.rs",
            "os/StarryOS/kernel/src/syscall/io_mpx/mod.rs",
